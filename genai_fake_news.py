...
def main():
    ...
    user_input = input(f"Enter article index (0-{len(docs)-1}) or paste custom news text for explanation (leave blank for index 0): ")
    ...
    if sample_idx is not None:
        ...
        print('Model prediction:', preds[sample_idx]['label'], f"(confidence: {preds[sample_idx]['score']:.2f})")
    else:
